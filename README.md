uMenu is a simple menu GUI in MicroPython for 2x16 LCDs. For now it supports only joystick with a push button as an input.
...
# LCD functions are specified and joystick setup is done
